...
Schema covers the full range of medical document types encountered in oncology
...
class ImagingResult(BaseModel):
    ...
    Covers Befundbericht and Radiologiebericht document types.
    """
...
class Symptom(BaseModel):
    ...
    Covers patient-reported problems and physical examination findings.
    """
...
class Allergy(BaseModel):
    ...
    Critical for medication safety across documents.
    """
...
class VitalSigns(BaseModel):
    """
    A set of vital sign measurements: blood pressure, pulse, weight, height, temperature, etc.
    Often found in Arztbrief, Aufnahmeuntersuchung, or Verlaufsbericht documents.
    """
...
class Referral(BaseModel):
    ...
    Found in Überweisungsbrief and consultation documents.
    """
...
class Appointment(BaseModel):
    ...
    Captures future care steps and follow-up schedules.
    """
...
MEDICAL_ENTITY_TYPES: dict = {
    ...
    # Expanded — any medical document type
